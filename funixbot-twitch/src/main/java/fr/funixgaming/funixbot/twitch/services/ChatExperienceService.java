...
@Slf4j
@Component
public class ChatExperienceService {
    private static volatile ChatExperienceService instance = null;
    ...
    public ChatExperienceService(BotConfig botConfig,
                                 TwitchBot twitchBot,
    ...
    public static ChatExperienceService getInstance() throws FunixBotException {
        if (instance == null) {
